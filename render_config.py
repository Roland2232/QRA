...
class RenderConfig:
    ...
    # Email Configuration - Gmail SMTP (using working credentials from app.py)
    MAIL_SERVER = 'smtp.gmail.com'
    MAIL_PORT = 587
    MAIL_USE_TLS = True
    MAIL_USERNAME = os.environ.get('MAIL_USERNAME', 'notorios2003@gmail.com')
    MAIL_PASSWORD = os.environ.get('MAIL_PASSWORD', 'thsl usar tiol uvxi')
    MAIL_DEFAULT_SENDER = os.environ.get('MAIL_DEFAULT_SENDER', 'notorios2003@gmail.com')
